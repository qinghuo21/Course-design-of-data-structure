...
void borrowList(LinkList &la)				//图书借阅 
{
 ...
 void findbook(LinkList &la){		//查找书籍 
	...
	if(key==1){
		...
		printf("\n");
		while(q!=NULL){
			if(strcmp(p->book,s)){			//查找book与输入的字符串相同的q 
				break;
			}
		}
	...
	if(key==2){
		...
		printf("\n");
		while(q!=NULL){
			if(p->booknumber==booknumber){		//查找booknumber与输入的字符串相同的q
				break;
			}
		}
	printf("书号：%d		",q->booknumber);
	...
	if(key==3){
		...
		printf("\n");
		while(q!=NULL){
			if(strcmp(p->author,s)){		//查找author与输入的字符串相同的q
				break;
			}
		}
	printf("书号：%d		",q->booknumber);
	...
	if(key==4){
		...
		printf("\n");
		while(q!=NULL){
			if(strcmp(p->authorhouse,s)){		//查找authorhouse与输入的字符串相同的q
				break;
			}
		}
	printf("书号：%d		",q->booknumber);
